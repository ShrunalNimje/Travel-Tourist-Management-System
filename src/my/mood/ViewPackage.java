...
public class ViewPackage extends JFrame{
    ...
    public ViewPackage(String username){
        ...
        String [] package1 = {"KERALA PACKAGE", "INCLUDES", "Pick & Drop from Airport/Railway Station", "2N in Munnar", "1N in Thekkady", "1N in Houseboat", "1N in Kochi", "Breakfast & Dinner", "Sightseeing & All Transportation", "EXCLUDES", "Lunch", "Air/Train Ticket", "Any Ride", "Any Personal Expenses", "viewPackage-removebg-preview.png", "Package Cost", "5 Couples : 14500/- per Person", "3 Couples : 16000/- per Person", "2 Couples : 18500/- per Person", "1 Couples : 21000/- per Person", "BOOK NOW"};
        String [] package2 = {"HIMACHAL PACKAGE", "INCLUDES", "6 days travel", "Daily Breakfast & Dinner", "Sightseeing by AC Car", "Pick up / Drop : DELHI", "2 Nigths in Shimla", "3 Nights in Manali", "1 Nights in Dharamshala", "EXCLUDES", "Train / Air / Bus Tickets", "Any Personal Expences", "Any Ride", "", "viewPackage1-removebg-preview.png", "Package Cost", "5 Couples : 16000/- per Person", "3 Couples : 19500/- per Person", "2 Couples : 22500/- per Person", "1 Couples : 25000/- per Person", "BOOK NOW"};
        String [] package3 = {"GOA PACKAGE", "INCLUDES", "4 days stay in Hotel / Resort", "Pick up & Drop", "3 Night & 4 Day Accomodation", "Daily Breakfast & Dinner", "1 Day Sight seen", "Complementary usage of Swimming pool", "All Tours & Transfer on Sic basis", "EXCLUDES", "Train / Air / Bus Tickets", "Any Personal Expences", "AirFare", "Extra GST", "viewPackage2-removebg-preview.png","Package Cost", "3 Couples : 22800/- per Person", "2 Couples : 24000/- per Person", "1 Couples : 28000/- per Person", "", "BOOK NOW"};
    ...
    public JPanel createPackage(String [] arr){
        ...
        JLabel book = new JLabel(arr[20]);
        book.setBounds(1000, 480, 300, 30);
